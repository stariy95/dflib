...
/**
 * QL {@code plusDays(e, n)}: adds a constant number of days to a temporal expression, preserving the receiver type.
 * A {@code TimeExp} receiver is rejected: a time has no date part.
 *
 * @since 2.0.0
 */
